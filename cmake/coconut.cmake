...
if(NOT EXISTS "${COCOGEN_DIR}/cocogen")
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}" -B "${COCONUT_BUILD_DIR}" -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_FLAGS=${COCONUT_COMPILE_OPTIONS} -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}
